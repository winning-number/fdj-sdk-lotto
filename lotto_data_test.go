...
//nolint:maintidx // just a playground of test render by a function to avoid global variables
func dataGrandLottoV3() []Draw {
	return []Draw{
		{
			Metadata: Metadata{
				Version:        DrawV3,
...
func dataGrandLottoNoelV3() []Draw {
	return []Draw{
		{
			Metadata: Metadata{
				Version:        DrawV3,
