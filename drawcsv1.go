...
// DrawCSV1 define the model for the draws before 2008 october
type DrawCSV1 struct {
...
func (d DrawCSV1) ConvertDraw(drawType DrawType) (Draw, error) {
	var draw Draw
	var err error
...
func (d DrawCSV1) ConvertWinStats() (WinStats, error) {
	var err error
	wStat := WinStats{
		WinNumber: []int32{
			d.WinnerR1,
...
func (d DrawCSV1) ConvertJoker() Joker {
	return Joker{
		Base: d.Joker,
		Plus: d.JokerPlus,
	}
...
func (d DrawCSV1) ConvertDrawBalls() DrawBall {
	var balls DrawBall
...
func (d DrawCSV1) ConvertMetadata(drawType DrawType) (Metadata, error) {
	var meta Metadata
	var err error
